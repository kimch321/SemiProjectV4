        ...
        <form action="checkfrm1" name="checkfrm1">
            ...
            <div class="row">
                <div class="col text-center">
                    ...
                    <button type="button" class="btn btn-primary" id="check1btn"><i class="fas fa-check"></i>확인하기
                    </button>
                    <button type="button" class="btn btn-danger" id="cancle1btn"><i class="fas fa-times"></i>취소하기
                    </button>
                </div>
            </div>
        </form>
    ...
    <div class="card card-body bg-light mt-5 mx-3">
        ...
        <form id="checkfrm2" name="checkfrm2">
            ...
            <div class="row">
                <div class="col text-center">
                    <hr class="w-75 mx-auto">
                    <button type="button" class="btn btn-primary" id="check2btn"><i class="fas fa-check"></i>확인하기
                    </button>
                    <button type="button" class="btn btn-danger" id="cancle2btn"><i class="fas fa-times"></i>취소하기
                    </button>
                </div>
            </div>
        </form>
